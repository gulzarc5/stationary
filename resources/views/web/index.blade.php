@extends('web.templet.master')
  ...
  @section('content')
        ...
        <div class="site__body">
            <!-- Home Slider -->
            <div class="block-space block-space--layout--divider-xs" style="height: 15px;"></div>
            ...
            <!-- Home Catagory -->
            <div class="block-space block-space--layout--divider-nl home-divider"></div>
            <div class="block block-categories home-categories">
                <div class="container">
                    <div class="block-categories__header">
                        <div class="block-categories__title">Disposable Products
            ...
            <div class="block block-categories home-categories">
                <div class="container">
                    <div class="block-categories__header">
                        <div class="block-categories__title">Housekeeping Products
                            <div class="decor block-categories__title-decor decor--type--center">
                                <div class="decor__body">
                                    <div class="decor__start"></div>
                                    <div class="decor__end"></div>
            ...
            <div class="block block-categories home-categories">
                <div class="container">
                    <div class="block-categories__header">
                        <div class="block-categories__title">Packaging Material
                            <div class="decor block-categories__title-decor decor--type--center">
                                <div class="decor__body">
                                    <div class="decor__start"></div>
                                    <div class="decor__end"></div>
            ...
            <div class="block block-categories home-categories">
                <div class="container">
                    <div class="block-categories__header">
                        <div class="block-categories__title">Stationery
                            <div class="decor block-categories__title-decor decor--type--center">
                                <div class="decor__body">
                                    <div class="decor__start"></div>
                                    <div class="decor__end"></div>
            ...
            <div class="block block-sale">
                <div class="block-sale__content">
                    <div class="block-sale__header">
                        <div class="block-sale__title">Newest Arrival</div>
                        <div class="block-sale__subtitle">Hurry up! grab our newest arrival</div><br>
            ...
            <div class="block block-posts-carousel block-posts-carousel--layout--list" data-layout="list">
                <div class="container-fluid">
                    <div class="about__block__inner" style="background-color: rgb(242, 242, 242);">
                        <div class=" row responsive-row">
                            <div class=" col-md-6 main-image responsive-image image-left">
                                <div class="editable-image-holder">
                                    <div class="editable-content  " data-a-delay="0"><img src="{{asset('web/images/about/DE26CB0F8B5234C7522D88E084_1499264867562.webp')}}" alt="" class=" img-loaded" style="border-radius: 10px;width: 100%"></div>
                                </div>
                            </div>
                            <div class=" col-md-6 responsive-content">
                                ...
                                <div class=" editable-content-holder">
                                   <div class="about__card-text">RedParts is an international company with 30 years of history selling spare parts for cars, trucks and motorcycles. During our work we managed to create a unique service for the sale and delivery of spare parts around the world. We, Samriddhi strives to make your buying experience simple and straightforward by offering intelligent stationery items of top brands and competitive prices. You can shop online for the world class brands at low rates. </div>
                                </div>
                            </div>
                        </div>
                    </div>
