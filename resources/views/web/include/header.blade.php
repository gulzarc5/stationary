                    ...
                    <div class="header__navbar-menu">
                        <div class="main-menu">
                            <ul class="main-menu__list">
                                ...
                                <li class="main-menu__item"><a href="index.html" class="main-menu__link">Gallery</a>
                                </li>
                        ...
                        <div class="indicator__content">
                            <div class="dropcart">
                                <ul class="dropcart__list">
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image">
                                            <a href="product-full.html"><img src="{{asset('web/images/products/product-5-70x70.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="dropcart__item-info">
                                ...
                                <div class="dropcart__actions"><a href="{{route('web.cart.cart')}}" class="btn btn-secondary">View Cart</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
